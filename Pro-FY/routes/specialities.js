...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('specialities');

// This file contains the logic of every route in Forest Admin for the collection specialities:
...
// Create a Speciality
router.post('/specialities', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Speciality
router.put('/specialities/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Speciality
router.delete('/specialities/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Specialities
router.get('/specialities', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Specialities
router.get('/specialities/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Speciality
router.get('/specialities/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Specialities
router.get('/specialities.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Specialities
router.delete('/specialities', permissionMiddlewareCreator.delete(), (request, response, next) => {
