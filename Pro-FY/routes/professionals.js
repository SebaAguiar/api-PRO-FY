...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('professionals');

// This file contains the logic of every route in Forest Admin for the collection professionals:
...
router.post('/professionals', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/professionals/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/professionals/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/professionals', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Professionals
router.get('/professionals/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Professional
router.get('/professionals/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Professionals
router.get('/professionals.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Professionals
router.delete('/professionals', permissionMiddlewareCreator.delete(), (request, response, next) => {
